...
namespace LD48 {
    public class Player : MonoBehaviour {
        ...
        public void ShowDiamondTooltip() {
            StartCoroutine(DiamondTooltip());
        }

        public IEnumerator DiamondTooltip() {
            float timeElapsed = 0;

            while(timeElapsed < 5.0f) {
                UIManager.Instance.DisplayTextPanel(Player.Instance.tutorialTransform, "You have found the diamond\nBring it to the surface");
